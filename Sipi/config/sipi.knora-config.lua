...
sipi = {
    ...
    --
    imgroot = '/root/Sipi/images', -- make sure that this directory exists
    ...
    --
    initscript = '/root/Sipi/config/sipi.init-knora.lua',

    --
    -- path to the caching directory
    --
    cachedir = '/root/Sipi/cache',
